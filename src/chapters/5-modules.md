...
複数のモジュールのHaskellプログラムは各実体の特有の名前を与え、適切な特有の名前に参照するために全出現を変更し、その時すべてのモジュールの実体<sup><a href="https://www.haskell.org/onlinereport/haskell2010/haskell12.html">1</a></sup>を連結することによって単一のモジュールプログラムに変換されることが可能だ。
